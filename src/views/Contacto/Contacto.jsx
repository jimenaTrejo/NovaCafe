...
function Contacto() {
    return (
        ...
        <div>
            <h1 className="text-3xl font-extrabold">Mandanos tus comentarios</h1>
            <p className="text-sm text-gray-400 mt-3">Dinos lo que piensas para ayudarnos a mejorar nuestra pagina</p>
            <div className="mt-12">
                ...
                <ul className="mt-3">
                    <li className="flex items-center">
                        ...
                        <a target="blank" href="https://veilmail.io/e/FkKh7o" className="text-[#007bff] text-sm ml-3">
                            ...
                            <strong>jimenos0411@gmail.com</strong>
                        </a>
                    </li>
                </ul>
            </div>
            <div className="mt-12">
                ...
                <ul className="flex mt-3 space-x-4">
                    <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        <a href="https://www.facebook.com/institutonovaerasilao">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        <a href="https://www.linkedin.com/company/instituto-novaera-oficial/mycompany/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                                viewBox="0 0 511 512">
                                <path
                    ...
                    <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        <a href="https://www.instagram.com/instituto_novaera/?hl=es">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                                viewBox="0 0 24 24">
                                <path
        ...
        <form action="https://fabform.io/f/xxxxx" method="post" className="ml-auo space-y-4">
            ...
            <button type="submit"
                className="text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Enviar</button>
        </form>
    </div>
</div>
